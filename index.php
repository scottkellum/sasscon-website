...
<!--[if gt IE 9]><!--><html class="no-js" lang="en"><!--<![endif]-->
  <head>
    ...
    <link href='/js/libs/flickrbomb/css/flickrbomb.css?v=1' rel='stylesheet' />
  ...
  <!--     <figure class="sass-robot">
        <img src="images/sass-robot.svg" alt="Sass Robot">
      </figure> -->

      <!-- Begin MailChimp Signup Form -->
      <div id="mc_embed_signup">
        <form action="http://scottkellum.us5.list-manage1.com/subscribe/post?u=3a8cdc2c932e9e39b71ad40fa&amp;id=f6ad155dea" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank">
          <div class="mc-field-group">
            <label for="mce-EMAIL">Stay Informed:</label>
            <input type="email" value="" placeholder=
            "Email Address" name="EMAIL" class="required email" id="mce-EMAIL"></div>
    ...
    <!-- <script src='/js/libs/flickrbomb/js/jquery.flickrbomb.min.js?v=1'></script> -->
    <!--[if (lt IE 9) & (!IEMobile)]>
